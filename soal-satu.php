...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo ", jumlah kata: " . str_word_count($first_sentence) . "<b> Dari Kata $first_sentence </b><br>";
     
        $second_sentence = "I'm ready for the challenges"; // Panjang string: 28,  jumlah kata: 5
        echo "Panjang String: " . strlen($second_sentence);
        echo ", jumlah kata: " . str_word_count($second_sentence) . "<b> Dari Kata $second_sentence </b><br>";
